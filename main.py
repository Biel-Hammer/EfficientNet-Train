...
from utils.autoaugment import SVHNPolicy
    ...
    if "efficientnet" in args.arch:  # NEW
        if args.pretrained:
            model = EfficientNet.from_pretrained(
                args.arch, weights_path="model_best.pth.tar", advprop=args.advprop
            )
    ...
    train_dataset = datasets.ImageFolder(
        ...
        transforms.Compose(
            [
                ...
                transforms.Resize(
                    (image_size, image_size), interpolation=PIL.Image.BICUBIC
                ),
                normalize,
            ]
        ),
